...
/** 콘텐츠심사이력 */
@Entity
@Table(schema = "vi", name = "vi_ctt_judge_hist")
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
...
public class ViCttJudgeHist extends RegEntity implements Identifiable<UUID> {

  /** 콘텐츠심사이력식별번호 */
  @Id
  @GeneratedValue(strategy = GenerationType.AUTO)
  @Column(name = "ctt_judge_hist_id", nullable = false)
  private UUID cttJudgeHistId;

  /** 콘텐츠심사요청식별번호 */
  @Column(name = "ctt_judge_req_id")
  ...
  /** 바이너리이미지그룹식별번호 */
  @Column(name = "bin_img_group_id")
  private UUID binImgGroupId;

  /** 바이너리파일그룹식별번호 */
  @Column(name = "bin_file_group_id")
